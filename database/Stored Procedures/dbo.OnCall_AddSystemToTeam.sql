...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_AddSystemToTeam]
--
----------------------------------------------------------------------------------
...
CREATE PROCEDURE [dbo].[OnCall_AddSystemToTeam]
@TeamID INTEGER,
@SystemID INTEGER
...
BEGIN TRY
		...
		INSERT INTO [OnCallTeamSystems]
				([TeamID], [SystemID], [CreateDate], [LastUpdateDate])
		 VALUES
				(@TeamID, @SystemID, getdate(), getdate())
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_AddSystemToTeam. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_AddSystemToTeam] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_AddSystemToTeam] TO [OnCall]
GO
