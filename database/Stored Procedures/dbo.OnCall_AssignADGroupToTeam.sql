...
-- ------------------------------------------------------------------------  
-- Stored Procedure:  [OnCall_AssignADGroupToTeam]  
--  
----------------------------------------------------------------------------------  
...
-- ------------------------------------------------------------------------  
--  
-- Description: This procedure is used to assign an AD group to a team.  
-- ------------------------------------------------------------------------  
  
----------------------------------------------------------------------------------  
  
CREATE PROCEDURE [dbo].[OnCall_AssignADGroupToTeam]  
@ADGroupID INTEGER,  
@TeamID INTEGER   
...
BEGIN TRY  
 ...
 UPDATE [OnCall].[dbo].[OnCallADGroups]  
    SET [TeamID] = @TeamID  
...
BEGIN CATCH  
   ...
   --SET @errorMessage = 'Error in executing OnCall_AssignADGroupToTeam. '  
...
RETURN  
GO
GRANT EXECUTE ON  [dbo].[OnCall_AssignADGroupToTeam] TO [AllAccess]
GO
