...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_DeleteRecurringSchedule]
--
----------------------------------------------------------------------------------
--COPYRIGHT (C) 2007 Quicken Loans Inc.
----------------------------------------------------------------------------------
--OnCall_DeleteRecurringSchedule STORED PROCEDURE CREATION SCRIPT
----------------------------------------------------------------------------------
--
-- Revision History:
--
...
CREATE PROCEDURE [dbo].[OnCall_DeleteRecurringSchedule]
...
BEGIN TRY
	...
	BEGIN TRANSACTION
		...
		UPDATE [OnCallSchedules]
		   SET [RecurranceID] = NULL
		 WHERE [RecurranceID] = @RecurranceID AND [StartDate] < getdate()
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_DeleteRecurringSchedule. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_DeleteRecurringSchedule] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_DeleteRecurringSchedule] TO [OnCall]
GO
