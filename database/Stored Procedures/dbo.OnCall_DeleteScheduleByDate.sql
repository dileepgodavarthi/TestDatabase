...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_DeleteScheduleByDate]
--
----------------------------------------------------------------------------------
--COPYRIGHT (C) 2007 Quicken Loans Inc.
----------------------------------------------------------------------------------
--OnCall_DeleteScheduleByDate STORED PROCEDURE CREATION SCRIPT
----------------------------------------------------------------------------------
--
-- Revision History:
--
...
CREATE PROCEDURE [dbo].[OnCall_DeleteScheduleByDate]
@SunsetDate DATETIME
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_DeleteScheduleByDate. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_DeleteScheduleByDate] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_DeleteScheduleByDate] TO [OnCall]
GO
