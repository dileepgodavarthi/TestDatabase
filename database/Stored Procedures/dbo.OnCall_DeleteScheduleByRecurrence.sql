...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_DeleteScheduleByRecurrence]
--
----------------------------------------------------------------------------------
--COPYRIGHT (C) 2007 Quicken Loans Inc.
----------------------------------------------------------------------------------
--OnCall_DeleteScheduleByRecurrence STORED PROCEDURE CREATION SCRIPT
----------------------------------------------------------------------------------
--
-- Revision History:
--
...
CREATE PROCEDURE [dbo].[OnCall_DeleteScheduleByRecurrence]
...
BEGIN TRY
	...
	BEGIN
		RAISERROR('The RecurrenceID must be provided in OnCall_DeleteScheduleByRecurrence!',16,1)
		RETURN -1
	END

	DELETE FROM  [OnCallSchedules]
	 WHERE [RecurranceID] = @RecurrenceID
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_DeleteScheduleByRecurrence. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_DeleteScheduleByRecurrence] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_DeleteScheduleByRecurrence] TO [OnCall]
GO
