...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_DeleteSystemKeyword]
--
----------------------------------------------------------------------------------
--COPYRIGHT (C) 2007 Quicken Loans Inc.
----------------------------------------------------------------------------------
--OnCall_DeleteSystemKeyword STORED PROCEDURE CREATION SCRIPT
----------------------------------------------------------------------------------
--
-- Revision History:
--
...
CREATE PROCEDURE [dbo].[OnCall_DeleteSystemKeyword]
@SystemKeywordID INTEGER
...
BEGIN TRY
	...
	DELETE FROM  [OnCallSystemKeywords]
	 WHERE [SystemKeywordID] = @SystemKeywordID
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_DeleteSystemKeyword. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_DeleteSystemKeyword] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_DeleteSystemKeyword] TO [OnCall]
GO
