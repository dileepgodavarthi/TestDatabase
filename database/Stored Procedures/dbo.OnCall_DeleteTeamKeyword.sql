...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_DeleteTeamKeyword]
--
----------------------------------------------------------------------------------
--COPYRIGHT (C) 2007 Quicken Loans Inc.
----------------------------------------------------------------------------------
--OnCall_DeleteTeamKeyword STORED PROCEDURE CREATION SCRIPT
----------------------------------------------------------------------------------
--
-- Revision History:
--
...
CREATE PROCEDURE [dbo].[OnCall_DeleteTeamKeyword]
@TeamKeywordID INTEGER
...
BEGIN TRY
	...
	DELETE FROM  [OnCallTeamKeywords]
	 WHERE [TeamKeywordID] = @TeamKeywordID
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_DeleteTeamKeyword. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_DeleteTeamKeyword] TO [AllAccess]
GO
