...
-- ------------------------------------------------------------------------  
-- Stored Procedure:  [OnCall_GetADGroupsByTeam]  
--  
----------------------------------------------------------------------------------  
...
-- ------------------------------------------------------------------------  
--  
-- Description: This procedure is used to retrieve AD groups associated with a team.  
-- ------------------------------------------------------------------------  
  
----------------------------------------------------------------------------------  
  
CREATE PROCEDURE [dbo].[OnCall_GetADGroupsByTeam]  
@TeamID INTEGER  
AS  
...
BEGIN TRY  
 ...
 SELECT [ADGroupID], [ADTeam], [ADSubTeam]  
...
BEGIN CATCH  
   ...
   --SET @errorMessage = 'Error in executing OnCall_GetADGroupsByTeam. '  
...
RETURN  
GO
GRANT EXECUTE ON  [dbo].[OnCall_GetADGroupsByTeam] TO [AllAccess]
GO
