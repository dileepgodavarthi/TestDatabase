...
-- ------------------------------------------------------------------------  
-- Stored Procedure:  [OnCall_GetAllADGroups]  
--  
----------------------------------------------------------------------------------  
...
-- ------------------------------------------------------------------------  
--  
-- Description: This procedure is used to retrieve all AD groups  
-- ------------------------------------------------------------------------  
  
----------------------------------------------------------------------------------  
  
CREATE PROCEDURE [dbo].[OnCall_GetAllADGroups]  
...
BEGIN TRY  
 ...
 SELECT [ADGroupID], [ADTeam], [ADSubTeam], [TeamID]  
   FROM [OnCall].[dbo].[OnCallADGroups]  
     ORDER BY [ADTeam], [ADSubTeam]  
...
BEGIN CATCH  
   ...
   --SET @errorMessage = 'Error in executing OnCall_GetAllADGroups. '  
...
RETURN  
GO
GRANT EXECUTE ON  [dbo].[OnCall_GetAllADGroups] TO [AllAccess]
GO
