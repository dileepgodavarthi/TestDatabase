...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_GetContactNames]
--
----------------------------------------------------------------------------------
...
CREATE PROCEDURE [dbo].[OnCall_GetContactNames]
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_GetContactNames] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_GetContactNames] TO [OnCall]
GO
