...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_GetKeywordsBySystem]
--
----------------------------------------------------------------------------------
...
CREATE PROCEDURE [dbo].[OnCall_GetKeywordsBySystem]
@SystemID INTEGER
...
BEGIN TRY
	...
	SELECT [SystemKeywordID], [Keyword]
		FROM [OnCallSystemKeywords] con			
		WHERE
			[SystemID] = @SystemID
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_GetKeywordsBySystem. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_GetKeywordsBySystem] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_GetKeywordsBySystem] TO [OnCall]
GO
