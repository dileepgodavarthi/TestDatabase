...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_GetKeywordsByTeam]
--
----------------------------------------------------------------------------------
--COPYRIGHT (C) 2007 Quicken Loans Inc.
----------------------------------------------------------------------------------
--OnCall_GetKeywordsByTeam STORED PROCEDURE CREATION SCRIPT
----------------------------------------------------------------------------------
--
-- Revision History:
--
...
CREATE PROCEDURE [dbo].[OnCall_GetKeywordsByTeam]
@TeamID INTEGER
...
BEGIN TRY
	...
	SELECT [TeamKeywordID], [Keyword]
		FROM [OnCallTeamKeywords] con			
		WHERE
			[TeamID] = @TeamID
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_GetKeywordsByTeam. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_GetKeywordsByTeam] TO [AllAccess]
GO
