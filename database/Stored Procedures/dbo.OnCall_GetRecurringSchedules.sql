...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_GetRecurringSchedules]
--
----------------------------------------------------------------------------------
--COPYRIGHT (C) 2007 Quicken Loans Inc.
----------------------------------------------------------------------------------
--OnCall_GetRecurringSchedules STORED PROCEDURE CREATION SCRIPT
----------------------------------------------------------------------------------
--
-- Revision History:
--
...
CREATE PROCEDURE [dbo].[OnCall_GetRecurringSchedules]
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_GetRecurringSchedules. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_GetRecurringSchedules] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_GetRecurringSchedules] TO [OnCall]
GO
