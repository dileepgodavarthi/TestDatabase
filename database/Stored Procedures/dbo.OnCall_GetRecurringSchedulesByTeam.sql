...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_GetRecurringSchedulesByTeam]
--
----------------------------------------------------------------------------------
--COPYRIGHT (C) 2007 Quicken Loans Inc.
----------------------------------------------------------------------------------
--OnCall_GetRecurringSchedulesByTeam STORED PROCEDURE CREATION SCRIPT
----------------------------------------------------------------------------------
--
-- Revision History:
--
...
CREATE PROCEDURE [dbo].[OnCall_GetRecurringSchedulesByTeam]
@TeamID INTEGER
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_GetRecurringSchedulesByTeam. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_GetRecurringSchedulesByTeam] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_GetRecurringSchedulesByTeam] TO [OnCall]
GO
