...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_GetRecurringSchedulesByTeamAndRole]
--
----------------------------------------------------------------------------------
--COPYRIGHT (C) 2007 Quicken Loans Inc.
----------------------------------------------------------------------------------
--OnCall_GetRecurringSchedulesByTeamAndRole STORED PROCEDURE CREATION SCRIPT
----------------------------------------------------------------------------------
--
-- Revision History:
--
...
CREATE PROCEDURE [dbo].[OnCall_GetRecurringSchedulesByTeamAndRole]
@TeamID INTEGER,
@RoleID INTEGER
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_GetRecurringSchedulesByTeamAndRole. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_GetRecurringSchedulesByTeamAndRole] TO [AllAccess]
GO
