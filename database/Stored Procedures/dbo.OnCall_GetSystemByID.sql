...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_GetSystemByID]
--
----------------------------------------------------------------------------------
...
CREATE PROCEDURE [dbo].[OnCall_GetSystemByID]
@SystemID INTEGER
...
BEGIN TRY
	...
	IF (@SystemID IS NULL)
	BEGIN
		RAISERROR('The SystemID must be provided in OnCall_GetSystemByID!',16,1)
		RETURN -1
	END
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_GetSystemByID. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_GetSystemByID] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_GetSystemByID] TO [OnCall]
GO
