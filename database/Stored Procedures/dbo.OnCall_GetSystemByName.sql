...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_GetSystemByName]
--
----------------------------------------------------------------------------------
...
CREATE PROCEDURE [dbo].[OnCall_GetSystemByName]
@Name VARCHAR(50)
...
BEGIN TRY
	...
	SELECT [SystemID], [Name], [PrimaryTechID]
	  FROM [OnCallSystems]
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_GetSystemByName. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_GetSystemByName] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_GetSystemByName] TO [OnCall]
GO
