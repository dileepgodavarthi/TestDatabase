...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_GetTeamsBySystemID]
--
----------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------
--
-- Description:	This procedure is used to get all contact names
-- ------------------------------------------------------------------------

----------------------------------------------------------------------------------

CREATE PROCEDURE [dbo].[OnCall_GetTeamsBySystemID]
@SystemID INTEGER
...
BEGIN TRY
	...
	SELECT s.[TeamID], [Name]		  
	  FROM [OnCallTeamSystems] s
		INNER JOIN [OnCallTeams] t ON s.[TeamID] = t.[TeamID]
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_GetTeamsBySystemID] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_GetTeamsBySystemID] TO [OnCall]
GO
