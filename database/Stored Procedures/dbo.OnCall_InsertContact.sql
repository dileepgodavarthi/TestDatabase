...
----------------------------------------------------------------------------------
--OnCall_InsertContact STORED PROCEDURE CREATION SCRIPT
----------------------------------------------------------------------------------
--
-- Revision History:
--
...
CREATE PROCEDURE [dbo].[OnCall_InsertContact]
...
BEGIN TRY
	...
	INSERT INTO [OnCallContacts] 
		([FirstName], [LastName], [Email], [WorkPhone], 
		 ...
		 [StartTime], [EndTime], [OffHoursPreferredContactType], [OnCallAdmin])
     VALUES
           (@FirstName, @LastName, @Email, @WorkPhone,
			@CellPhone, @HomePhone, @PreferredContactType, @Username, getdate(), getdate(), @StartTime, @EndTime, @OffHoursPreferredContactType, @OnCallAdmin)
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_InsertContact] TO [AllAccess]
GO
