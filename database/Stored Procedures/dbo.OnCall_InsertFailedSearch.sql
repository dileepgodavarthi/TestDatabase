...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_InsertFailedSearch]
--
----------------------------------------------------------------------------------
--COPYRIGHT (C) 2007 Quicken Loans Inc.
----------------------------------------------------------------------------------
--OnCall_InsertFailedSearch STORED PROCEDURE CREATION SCRIPT
----------------------------------------------------------------------------------
--
-- Revision History:
--
...
CREATE PROCEDURE [dbo].[OnCall_InsertFailedSearch]
@FailedSearchTerm VARCHAR(50)
...
BEGIN TRY
	...
	INSERT INTO [OnCall].[dbo].[OnCallFailedSearches]
			   ([FailedSearchTerm], [CreateDate], [LastUpdateDate])
		 VALUES
			   (@FailedSearchTerm, GETDATE(), GETDATE())
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_InsertFailedSearch. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_InsertFailedSearch] TO [AllAccess]
GO
