...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_InsertSchedule]
--
----------------------------------------------------------------------------------
--COPYRIGHT (C) 2007 Quicken Loans Inc.
----------------------------------------------------------------------------------
--OnCall_InsertSchedule STORED PROCEDURE CREATION SCRIPT
----------------------------------------------------------------------------------
--
-- Revision History:
--
...
CREATE PROCEDURE [dbo].[OnCall_InsertSchedule]
@TeamID INTEGER,
@StartDate DATETIME,
@EndDate DATETIME,
@RoleID INTEGER,
...
INSERT INTO [OnCallSchedules_Sumanth]
			   ([TeamID], [StartDate], [EndDate], [RoleID], [ContactID], [RecurranceID], [CreateDate], [LastUpdateDate])
		 VALUES
			   (@TeamID, @StartDate, @EndDate, @RoleID, @ContactID, @RecurranceID, getdate(), getdate())
			   
	INSERT INTO [OnCallSchedules]
			   ([TeamID], [StartDate], [EndDate], [RoleID], [ContactID], [RecurranceID], [CreateDate], [LastUpdateDate])
		 VALUES
			   (@TeamID, @StartDate, @EndDate, @RoleID, @ContactID, @RecurranceID, getdate(), getdate())
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_InsertSchedule. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_InsertSchedule] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_InsertSchedule] TO [OnCall]
GO
