...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_InsertTeamADGroup]
--
----------------------------------------------------------------------------------
--COPYRIGHT (C) 2007 Quicken Loans Inc.
----------------------------------------------------------------------------------
--OnCall_InsertTeamADGroup STORED PROCEDURE CREATION SCRIPT
----------------------------------------------------------------------------------
--
-- Revision History:
--
...
CREATE PROCEDURE [dbo].[OnCall_InsertTeamADGroup]
@TeamID INTEGER,
@ADGroup VARCHAR(50)
...
INSERT INTO [OnCallTeamADGroups]
           ([TeamID], [ADGroup], [CreateDate], [LastUpdateDate])
     VALUES
           (@TeamID, @ADGroup, getdate(), getdate())
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_InsertTeamADGroup. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_InsertTeamADGroup] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_InsertTeamADGroup] TO [OnCall]
GO
