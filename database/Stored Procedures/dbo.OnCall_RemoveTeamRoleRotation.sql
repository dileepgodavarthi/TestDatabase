...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_RemoveTeamRoleRotation]
--
----------------------------------------------------------------------------------
--COPYRIGHT (C) 2007 Quicken Loans Inc.
----------------------------------------------------------------------------------
--OnCall_RemoveTeamRoleRotation STORED PROCEDURE CREATION SCRIPT
----------------------------------------------------------------------------------
--
-- Revision History:
--
...
CREATE PROCEDURE [dbo].[OnCall_RemoveTeamRoleRotation]
@TeamID INTEGER,
@RoleID INTEGER
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_RemoveTeamRoleRotation. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_RemoveTeamRoleRotation] TO [AllAccess]
GO
