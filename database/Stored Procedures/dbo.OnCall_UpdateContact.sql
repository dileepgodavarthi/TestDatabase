...
CREATE PROCEDURE [dbo].[OnCall_UpdateContact]
@ContactID INTEGER,
...
RETURN
GO
GRANT VIEW DEFINITION ON  [dbo].[OnCall_UpdateContact] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_UpdateContact] TO [AllAccess]
GO
