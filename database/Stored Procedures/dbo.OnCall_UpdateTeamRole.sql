...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_UpdateTeamRole]
--
----------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------
--
-- Description:	This procedure is used to update a Team Role
-- ------------------------------------------------------------------------

----------------------------------------------------------------------------------

CREATE PROCEDURE [dbo].[OnCall_UpdateTeamRole]
@TeamID INTEGER,
@RoleID INTEGER,
@AllowUnscheduled BIT
...
BEGIN TRY
	...
	UPDATE [dbo].[OnCallTeamRoles]
	   SET [AllowUnscheduled] = @AllowUnscheduled,
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_UpdateTeamRole. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[OnCall_UpdateTeamRole] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[OnCall_UpdateTeamRole] TO [OnCall]
GO
