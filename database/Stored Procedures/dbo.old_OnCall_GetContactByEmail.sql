...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_GetContactsByEmail]
--
----------------------------------------------------------------------------------
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_GetContactsByEmail. '
...
GO
GRANT EXECUTE ON  [dbo].[old_OnCall_GetContactByEmail] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[old_OnCall_GetContactByEmail] TO [OnCall]
GO
