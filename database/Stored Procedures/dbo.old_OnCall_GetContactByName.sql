...
CREATE PROCEDURE [dbo].[old_OnCall_GetContactByName]
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[old_OnCall_GetContactByName] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[old_OnCall_GetContactByName] TO [OnCall]
GO
