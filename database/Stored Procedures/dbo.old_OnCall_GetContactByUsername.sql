...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_GetContactsByUsername]
--
----------------------------------------------------------------------------------
...
CREATE PROCEDURE [dbo].[old_OnCall_GetContactByUsername]
@Username VARCHAR(50)
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_GetContactsByUsername. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[old_OnCall_GetContactByUsername] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[old_OnCall_GetContactByUsername] TO [OnCall]
GO
