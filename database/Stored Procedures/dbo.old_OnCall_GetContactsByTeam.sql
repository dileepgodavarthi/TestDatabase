...
CREATE PROCEDURE [dbo].[old_OnCall_GetContactsByTeam]
@TeamID INTEGER
...
BEGIN TRY
	...
	SELECT con.[ContactID], tc.[TeamID], con.[FirstName], con.[LastName], con.[EMail],
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[old_OnCall_GetContactsByTeam] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[old_OnCall_GetContactsByTeam] TO [OnCall]
GO
