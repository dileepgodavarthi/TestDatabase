...
CREATE PROCEDURE [dbo].[old_OnCall_GetSchedulesByDateRange]
@StartDate DATETIME,
@EndDate DATETIME
...
RETURN
GO
GRANT VIEW DEFINITION ON  [dbo].[old_OnCall_GetSchedulesByDateRange] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[old_OnCall_GetSchedulesByDateRange] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[old_OnCall_GetSchedulesByDateRange] TO [OnCall]
GO
