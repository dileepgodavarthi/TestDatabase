...
----------------------------------------------------------------------------------  
--OnCall_GetTeamByName STORED PROCEDURE CREATION SCRIPT  
----------------------------------------------------------------------------------  
--  
-- Revision History:  
--  
...
CREATE PROCEDURE [dbo].[old_OnCall_GetTeamByName]  
@Name VARCHAR(50)  
...
RETURN  
GO
GRANT EXECUTE ON  [dbo].[old_OnCall_GetTeamByName] TO [AllAccess]
GO
