...
CREATE PROCEDURE [dbo].[old_OnCall_GetTeamFromADGroup]
@ADGroup VARCHAR(50)
...
BEGIN TRY
	...
	SELECT t.[TeamID], t.[Name], t.[OnCallEmail], t.[OnCallNumber], t.[OnCallExternalNumber], 
		...
		t.[PrimaryRole], t.[Hidden], t.[EmailDefault], t.[TeamLeader]
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[old_OnCall_GetTeamFromADGroup] TO [AllAccess]
GO
