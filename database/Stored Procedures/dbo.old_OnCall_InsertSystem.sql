...
-- ------------------------------------------------------------------------
-- Stored Procedure:  [OnCall_InsertSystem]
--
----------------------------------------------------------------------------------
--COPYRIGHT (C) 2007 Quicken Loans Inc.
----------------------------------------------------------------------------------
--OnCall_InsertSystem STORED PROCEDURE CREATION SCRIPT
----------------------------------------------------------------------------------
--
-- Revision History:
--
...
CREATE PROCEDURE [dbo].[old_OnCall_InsertSystem]
@Name VARCHAR(50)
...
BEGIN CATCH
   ...
   --SET @errorMessage = 'Error in executing OnCall_InsertSystem. '
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[old_OnCall_InsertSystem] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[old_OnCall_InsertSystem] TO [OnCall]
GO
