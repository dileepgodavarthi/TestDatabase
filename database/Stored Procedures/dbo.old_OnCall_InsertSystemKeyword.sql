...
CREATE PROCEDURE [dbo].[old_OnCall_InsertSystemKeyword]
@SystemID INTEGER,
@Keyword VARCHAR(50)
...
RETURN
GO
GRANT EXECUTE ON  [dbo].[old_OnCall_InsertSystemKeyword] TO [AllAccess]
GRANT EXECUTE ON  [dbo].[old_OnCall_InsertSystemKeyword] TO [OnCall]
GO
