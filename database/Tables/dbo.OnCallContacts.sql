...
GO
GRANT SELECT ON  [dbo].[OnCallContacts] TO [OnCall]
GRANT INSERT ON  [dbo].[OnCallContacts] TO [OnCall]
GRANT DELETE ON  [dbo].[OnCallContacts] TO [OnCall]
GRANT UPDATE ON  [dbo].[OnCallContacts] TO [OnCall]
GO
