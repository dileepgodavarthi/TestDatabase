...
GO
GRANT SELECT ON  [dbo].[OnCallFailedSearches] TO [AllAccess]
GRANT INSERT ON  [dbo].[OnCallFailedSearches] TO [AllAccess]
GRANT DELETE ON  [dbo].[OnCallFailedSearches] TO [AllAccess]
GRANT UPDATE ON  [dbo].[OnCallFailedSearches] TO [AllAccess]
GO
