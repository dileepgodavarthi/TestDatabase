...
GO
GRANT SELECT ON  [dbo].[OnCallTeamRotation] TO [AllAccess]
GRANT INSERT ON  [dbo].[OnCallTeamRotation] TO [AllAccess]
GRANT DELETE ON  [dbo].[OnCallTeamRotation] TO [AllAccess]
GRANT UPDATE ON  [dbo].[OnCallTeamRotation] TO [AllAccess]
GO
