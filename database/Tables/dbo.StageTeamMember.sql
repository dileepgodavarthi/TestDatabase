CREATE TABLE [dbo].[StageTeamMember]
(
...
GO
ALTER TABLE [dbo].[StageTeamMember] ADD CONSTRAINT [PK_StageTeamMember] PRIMARY KEY CLUSTERED  ([CommonId]) ON [OnCall_Data]
GO
EXEC sp_bindefault N'[dbo].[dfNow]', N'[dbo].[StageTeamMember].[CreateDate]'
GO
EXEC sp_bindefault N'[dbo].[dfNow]', N'[dbo].[StageTeamMember].[LastUpdateDate]'
GO
